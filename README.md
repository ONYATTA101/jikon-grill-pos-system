...
Open: [https://jikon-grill-pos-demo.vercel.app](https://jikon-grill-pos-demo.vercel.app)

Use any role username with the shared demo password `12345678`:

| Role | Username |
| --- | --- |
| Full reviewer | `reviewer` |
| Owner | `owner` |
| Manager | `manager` |
| Cashier | `cashier` |
| Waiter | `waiter` |
